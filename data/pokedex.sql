...
-- Import data into pokemon_size
.mode csv
.import "data/csv/pokemon_sizes.csv" "pokemon_sizes"
...
-- Import data into stat_names
.mode csv
.import "data/csv/stat_names.csv" "stat_names"
...
-- Import data into pokemon_descriptions
.mode csv
.import "data/csv/pokemon_descriptions.csv" "pokemon_descriptions"
...
-- Import data into pokemon_types
.mode csv
.import "data/csv/pokemon_types.csv" "pokemon_types"
...
-- Import data into pokemon_genders
.mode csv
.import "data/csv/pokemon_genders.csv" "pokemon_genders"
...
-- Import data into pokemon_stats
.mode csv
.import "data/csv/pokemon_stats.csv" "pokemon_stats"
...
-- Import data into pokemon
.mode csv
.import "data/csv/pokemon.csv" "pokemon"
...
-- Import data into abilities
.mode csv
.import "data/csv/abilities.csv" "abilities"
...
-- Import data into pokemon_species_names
.mode csv
.import "data/csv/pokemon_species_names.csv" "pokemon_species_names"
...
-- Import data into versions
.mode csv
.import "data/csv/versions.csv" "versions"
...
-- Import data into pokemon_abilities
.mode csv
.import "data/csv/pokemon_abilities.csv" "pokemon_abilities"

-- Create table for data/csv/types.csv
DROP TABLE IF EXISTS "types";
CREATE TABLE "types" ("id" INT NOT NULL, "identifier" TEXT NOT NULL);

-- Import data into types
.mode csv
.import "data/csv/types.csv" "types"
